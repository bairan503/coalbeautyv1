    ...
    <footer className="bg-near-black text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              <img src="/images/mdlogo.png" alt="苗绣竹韵" className="h-10 w-auto object-contain" />
              <span className="text-xl font-semibold">煤美与共</span>
            </div>
            <p className="text-secondary-text mb-4 max-w-md">
              煤美与共致力于挖掘和传承煤炭文化，通过文化创意赋能传统产业，推动资源型城市实现转型升级与可持续发展。
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><button onClick={() => onNavigate('culture')} className="text-secondary-text hover:text-white transition-colors">煤炭文化</button></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-2 text-secondary-text">
                ...
                <span>山西省太原市迎泽区煤炭大厦</span>
              </li>
              <li className="flex items-center space-x-2 text-secondary-text">
                <Phone className="w-4 h-4" />
                <span>+86 351 1234 5678</span>
              </li>
              <li className="flex items-center space-x-2 text-secondary-text">
                <Mail className="w-4 h-4" />
                <span>contact@meimeiyugong.com</span>
              </li>
              <li className="flex items-center space-x-2 text-secondary-text">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-secondary-text text-sm">
          <p>© 2026 煤美与共 版权所有 | 技术支持：NovaLynx 曜智科创</p>
          <p>   </p>
        </div>
      </div>
    </footer>
